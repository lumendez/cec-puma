...
RSpec.describe "grupos_unitarios/new", type: :view do
  before(:each) do
    assign(:grupos_unitario, GruposUnitario.new(
      :nombre => "MyString",
      :horario => "MyString",
      :estado => "MyString",
      :anio => "MyString",
  ...
  it "renders new grupos_unitario form" do
    render

    assert_select "form[action=?][method=?]", grupos_unitarios_path, "post" do
