...
RSpec.describe "grupos_diplomados/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit grupos_diplomado form" do
    render

    assert_select "form[action=?][method=?]", grupos_diplomado_path(@grupos_diplomado), "post" do
