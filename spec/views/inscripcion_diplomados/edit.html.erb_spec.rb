...
RSpec.describe "inscripcion_diplomados/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit inscripcion_diplomado form" do
    render

    assert_select "form[action=?][method=?]", inscripcion_diplomado_path(@inscripcion_diplomado), "post" do
